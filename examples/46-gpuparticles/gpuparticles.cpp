...
class ExampleGpuParticles : public entry::AppI
{
public:
	ExampleGpuParticles(const char* _name, const char* _description, const char* _url)
...
ENTRY_IMPLEMENT_MAIN(
	  ExampleGpuParticles
	, "46-gpuparticles"
	, "Compute-based GPU particle simulation"
	, ""
	);
